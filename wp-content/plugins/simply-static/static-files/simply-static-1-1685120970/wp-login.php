...
<html lang="pt-BR">
	...
	<title>Acessar &lsaquo; OliveiraPC &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=6.2.2" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost:8080/wordpress/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Acessar">
									<input type="hidden" name="redirect_to" value="http://localhost:8080/wordpress/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="/">&larr; Ir para OliveiraPC</a>		</p>
		<div class="privacy-policy-page-link"><a class="privacy-policy-link" href="/politica-de-privacidade/" rel="privacy-policy">Política de privacidade</a></div>	</div>
...
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"f517222008"};</script>
<script id="user-profile-js-translations">( function( domain, translations ) {
	var localeData = translations.locale_data[ domain ] || translations.locale_data.messages;
	localeData[""].domain = domain;
	wp.i18n.setLocaleData( localeData, domain );
} )( "default", {"translation-revision-date":"2023-03-28 21:15:49+0000","generator":"GlotPress\/4.0.0-alpha.4","domain":"messages","locale_data":{"messages":{"":{"domain":"messages","plural-forms":"nplurals=2; plural=n > 1;","lang":"pt_BR"},"Your new password has not been saved.":["Sua nova senha não foi salva."],"Hide":["Esconder"],"Show":["Mostrar"],"Confirm use of weak password":["Confirmar o uso de uma senha fraca"],"Hide password":["Ocultar senha"],"Show password":["Mostrar senha"]}},"comment":{"reference":"wp-admin\/js\/user-profile.js"}} );</script>
